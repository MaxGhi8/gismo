...
\paragraph{Conjugate gradient without preconditioner.}
...
and the total solve cost as $O\!\left(N^{3/2}/K^{1/2}\right)$~\cite[Ch.~5]{hackbusch1994iterative}.
...
$\kappa(M_{\mathrm{GS}}^{-1}A) = O(h^{-2})$~\cite[\S10.1]{saad2003iterative}.
